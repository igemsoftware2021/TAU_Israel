from TAU_Israel.modules import Zscore_calculation
from TAU_Israel.modules import nt_to_aa
...
def hill_climbing_optimize_by_zscore(seq, inp_dict, cai_or_tai, max_iter, optimization_type, nt_to_aa = nt_to_aa):
    '''
    ...
    '''
    seq_options = {}
    mean_opt_index, mean_deopt_index, zscore, weakest_score = Zscore_calculation.ZscoreModule.run_module(seq, inp_dict, cai_or_tai)
